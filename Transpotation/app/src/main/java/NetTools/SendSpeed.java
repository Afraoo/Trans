...
public class SendSpeed {
    ...
    public void sendSpeed(String teamNumber, String carNumber, String speed) {

        String originAddress = "http://192.168.3.25:8080/TServer/getSpeed";
